...
public class DarknessMobEffectMixin {
    ...
    private void changethatfog(FogRenderer.FogData fogData, LivingEntity entity, MobEffectInstance effectInstance, float farPlaneDistance, float partialTick, CallbackInfo ci)
